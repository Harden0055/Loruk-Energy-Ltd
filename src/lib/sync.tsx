      ...
      {showNotification && (
        <div className="fixed bottom-5 right-5 z-50 animate-fade-in-up">
          {showNotification === 'offline' && (
            <div className="flex items-center gap-4 bg-slate-900/95 dark:bg-white/5 text-slate-100 px-5 py-4 rounded-xl border border-amber-500/30 shadow-xl max-w-sm ">
          ...
          {showNotification === 'syncing' && (
            <div className="flex items-center gap-4 bg-slate-900/95 dark:bg-white/5 text-slate-100 px-5 py-4 rounded-xl border border-theme-border shadow-xl max-w-sm ">
          ...
          {showNotification === 'synced' && (
            <div className="flex items-center gap-4 bg-slate-900/95 dark:bg-white/5 text-slate-100 px-5 py-4 rounded-xl border border-emerald-500/30 shadow-xl max-w-sm ">

      ...
      <header className="p-4 border-b border-theme-border/30 bg-transparent flex flex-row items-center justify-between gap-4 z-10 relative">
         ...
         <div className="flex items-center gap-3">
           ...
           <div className="relative">
             ...
             >
               <option value="Combined Total" className="bg-[#121216] text-white font-medium">Combined Total</option>
               {STATIONS.map(s => <option key={s} value={s} className="bg-[#121216] text-white font-medium">{s}</option>)}
             </select>
